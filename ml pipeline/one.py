...
model = sm.Unet('vgg19', weights=None )
model.load_weights("vgg19_color_ntl_dataset12_shuffle_nocrops_augmented.hdf5")
...
test_path = 'D:/TAD/projects/malaria/img'
predict_path = 'D:/TAD/projects/malaria/predict'
